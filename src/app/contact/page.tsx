    ...
    <>
      ...
      <SectionWrapper className="bg-neutral-50 py-10 md:py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 max-w-6xl mx-auto">
          {/* Contact Information */}
          <div className="bg-white rounded-3xl shadow-lg border border-neutral-100 p-6 md:p-8 lg:p-10">
            <div className="mb-6">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3 p-3.5 bg-white rounded-xl border border-neutral-200 hover:border-primary/40 hover:shadow-md transition-all">
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="font-bold text-primary mb-1.5 text-sm">Alamat</h3>
                  <a
                    href={siteConfig.contact.googleMapsUrl}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-xs text-neutral-700 leading-relaxed hover:text-primary transition-colors block"
                  >
              ...
              <div className="flex items-start gap-3 p-3.5 bg-white rounded-xl border border-neutral-200 hover:border-primary/40 hover:shadow-md transition-all">
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="font-bold text-primary mb-1.5 text-sm">Email</h3>
                  <a
                    href={`mailto:${siteConfig.contact.email}`}
                    className="text-xs text-neutral-700 hover:text-primary transition-colors break-all"
                  >
              ...
              <div className="flex items-start gap-3 p-3.5 bg-white rounded-xl border border-neutral-200 hover:border-primary/40 hover:shadow-md transition-all">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <a
                    ...
                    className="text-xs text-neutral-700 hover:text-primary transition-colors block mb-1"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-xs text-neutral-700 hover:text-primary transition-colors"
                  >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 border border-neutral-300 rounded-lg focus:ring-2 focus:ring-[#00719c] focus:border-[#00719c] transition-all bg-white text-sm"
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  className="w-full px-3.5 py-2.5 border border-neutral-300 rounded-lg focus:ring-2 focus:ring-[#00719c] focus:border-[#00719c] transition-all resize-none bg-white text-sm"
              ...
              <button 
                type="submit" 
                className="w-full px-5 py-3 text-white font-bold rounded-lg transition-all duration-300 hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] text-sm"
                style={{ backgroundColor: '#00719c' }}
              >
                Kirim Pesan
              </button>
