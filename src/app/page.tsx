            ...
            <div className="p-5 md:p-6 lg:p-10">
              <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between mb-4">
                ...
                <p className="text-neutral-500 text-xs md:text-sm max-w-md text-left md:text-right">
                  Keunggulan yang membedakan NTI dalam industri manufaktur dan teknologi.
                </p>
              </div>
              ...
              <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6 lg:gap-8">
                <div className="flex-1 space-y-4">
                  ...
                  <p className="text-base md:text-lg text-white/85 leading-relaxed max-w-xl">
                    Feel free to contact us regarding your required of our products
                  </p>
                </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-neutral-900 mb-4">
              Solusi Terintegrasi untuk Kebutuhan Industri Anda
            </h2>
            <p className="text-lg text-neutral-600 max-w-2xl mx-auto">
              NTI tidak hanya menyediakan produk berkualitas, tetapi juga layanan komprehensif untuk memastikan kesuksesan proyek Anda
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {/* Konsultasi Teknis */}
            <div className="group bg-neutral-50 rounded-2xl p-6 border border-neutral-200 hover:border-primary/30 hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-neutral-600 text-sm leading-relaxed">
                Tim ahli kami siap membantu Anda memilih solusi terbaik sesuai kebutuhan spesifik industri Anda
              </p>
            </div>
            ...
            <div className="group bg-neutral-50 rounded-2xl p-6 border border-neutral-200 hover:border-primary/30 hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-neutral-600 text-sm leading-relaxed">
                Layanan maintenance, troubleshooting, dan dukungan teknis berkelanjutan untuk memastikan operasi optimal
              </p>
            </div>
            ...
            <div className="group bg-neutral-50 rounded-2xl p-6 border border-neutral-200 hover:border-primary/30 hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-neutral-600 text-sm leading-relaxed">
                Pengembangan produk dan solusi sesuai spesifikasi unik Anda dengan presisi dan kualitas tinggi
              </p>
            </div>
            ...
            <div className="group bg-neutral-50 rounded-2xl p-6 border border-neutral-200 hover:border-primary/30 hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-neutral-600 text-sm leading-relaxed">
                Program pelatihan dan dokumentasi lengkap untuk memastikan tim Anda dapat mengoperasikan produk dengan optimal
              </p>
            </div>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-xl p-5 md:p-6">
            <div className="text-center mb-4 md:mb-5">
              ...
              <p className="text-sm md:text-base text-white/90 max-w-xl mx-auto mb-4">
                Hubungi kami hari ini untuk konsultasi dan solusi terbaik untuk kebutuhan industri Anda
              </p>
            </div>
