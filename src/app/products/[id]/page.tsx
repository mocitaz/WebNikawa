              ...
              <div className="p-5 md:p-6 lg:p-8 xl:p-10 flex flex-col justify-center">
                ...
                <div className="grid grid-cols-3 gap-2 md:gap-3 mb-4 md:mb-6">
                  <div className="bg-primary/5 rounded-xl p-3 border border-primary/10">
                    ...
                    <div className="text-xs text-neutral-600">Fitur</div>
                  </div>
                  <div className="bg-primary/5 rounded-xl p-3 border border-primary/10">
                    <div className="text-lg md:text-xl font-bold text-primary mb-0.5">
                      {detail.applications.length}
                    </div>
                    <div className="text-xs text-neutral-600">Aplikasi</div>
                  </div>
                  <div className="bg-primary/5 rounded-xl p-3 border border-primary/10">
                    <div className="text-lg md:text-xl font-bold text-primary mb-0.5">
                      {detail.benefits.length}
                    </div>
                    <div className="text-xs text-neutral-600">Keunggulan</div>
                  </div>
                </div>
          ...
          <div className="bg-gradient-to-br from-primary/5 via-white to-primary/5 rounded-2xl border border-primary/10 p-6 md:p-8">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h2 className="text-lg md:text-xl font-bold text-neutral-900 mb-2">Overview</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
            ...
            <div className="bg-white rounded-2xl border border-neutral-100 shadow-sm p-5 md:p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-lg md:text-xl font-bold text-neutral-900">Fitur Utama</h2>
              </div>
            ...
            <div className="bg-white rounded-2xl border border-neutral-100 shadow-sm p-5 md:p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-lg md:text-xl font-bold text-neutral-900">Spesifikasi</h2>
              </div>
              <div className="space-y-2.5">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
            ...
            <div className="bg-gradient-to-br from-primary/5 via-white to-primary/5 rounded-2xl border border-primary/10 p-5 md:p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-lg md:text-xl font-bold text-neutral-900">Aplikasi</h2>
              </div>
            ...
            <div className="bg-gradient-to-br from-neutral-50 to-white rounded-2xl border border-neutral-100 p-5 md:p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-lg md:text-xl font-bold text-neutral-900">Keunggulan</h2>
              </div>
              <div className="space-y-2.5">
          ...
          <div className="bg-gradient-to-br from-primary via-primary-dark to-neutral-900 rounded-2xl p-6 md:p-8 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-2.5 justify-center">
                ...
                <a
                  href={`https://wa.me/${siteConfig.contact.whatsapp.replace(/[^0-9]/g, '')}?text=Halo,%20saya%20tertarik%20dengan%20produk%20${encodeURIComponent(product.name)}`}
                  target="_blank"
              ...
              <div className="flex flex-wrap items-center justify-center gap-2.5 mt-5 pt-5 border-t border-white/20 text-xs">
                ...
                <a
                  href={`mailto:${siteConfig.contact.email}?subject=Konsultasi%20Produk%20${encodeURIComponent(product.name)}`}
                  className="flex items-center gap-1.5 text-white/90 hover:text-white transition-colors"
                >
                  <svg className="w-3.5 h-3.5" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-6">
            ...
            <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-neutral-900 mb-2">
              Pertanyaan tentang {product.name}
            </h2>
          </div>
          ...
          <div className="space-y-2">
            ...
            <details className="group bg-white rounded-xl border border-neutral-200 overflow-hidden transition-all duration-200 hover:border-primary/40 hover:shadow-md">
              <summary className="flex items-center justify-between p-3 md:p-4 cursor-pointer list-none">
                <span className="text-sm md:text-base font-semibold text-neutral-900 pr-3">
                  Apa keunggulan utama {product.name}?
                </span>
                <svg
            ...
            <details className="group bg-white rounded-xl border border-neutral-200 overflow-hidden transition-all duration-200 hover:border-primary/40 hover:shadow-md">
              <summary className="flex items-center justify-between p-3 md:p-4 cursor-pointer list-none">
                <span className="text-sm md:text-base font-semibold text-neutral-900 pr-3">
                  Untuk aplikasi apa saja {product.name} dapat digunakan?
                </span>
                <svg
                  className="w-4 h-4 text-primary flex-shrink-0 transform transition-transform duration-200 group-open:rotate-180"
                  fill="none"
            ...
            <details className="group bg-white rounded-xl border border-neutral-200 overflow-hidden transition-all duration-200 hover:border-primary/40 hover:shadow-md">
              <summary className="flex items-center justify-between p-3 md:p-4 cursor-pointer list-none">
                <span className="text-sm md:text-base font-semibold text-neutral-900 pr-3">
                  Bagaimana cara memesan {product.name}?
                </span>
                <svg
                  className="w-4 h-4 text-primary flex-shrink-0 transform transition-transform duration-200 group-open:rotate-180"
                  fill="none"
                ...
                <div className="space-y-1.5">
                  ...
                  <ul className="space-y-1">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        <strong>Email:</strong>{' '}
                        <a href={`mailto:${siteConfig.contact.email}?subject=Penawaran%20${encodeURIComponent(product.name)}`} className="text-primary hover:underline">
                    ...
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        ...
                        <Link href={`/contact?product=${encodeURIComponent(product.name)}`} className="text-primary hover:underline">
                          Isi formulir kontak
                        </Link>
                      </span>
                    </li>
            ...
            <details className="group bg-white rounded-xl border border-neutral-200 overflow-hidden transition-all duration-200 hover:border-primary/40 hover:shadow-md">
              <summary className="flex items-center justify-between p-3 md:p-4 cursor-pointer list-none">
                <span className="text-sm md:text-base font-semibold text-neutral-900 pr-3">
                  Apakah {product.name} ready stock?
                </span>
                <svg
                  className="w-4 h-4 text-primary flex-shrink-0 transform transition-transform duration-200 group-open:rotate-180"
                  fill="none"
              ...
              <div className="px-3 md:px-4 pb-3 md:pb-4 text-sm text-neutral-600 leading-relaxed">
                {product.category === 'Electronics' || product.id === 'electronic-components' || product.id === 'plastic-resin' ? (
                  <p>
                    Ya, {product.name} tersedia ready stock di gudang Jababeka. Untuk informasi stok terkini, silakan hubungi tim kami.
                  </p>
                ) : product.id === 'pcba' ? (
                  <p>
                    PCBA tersedia untuk prototype (3-7 hari kerja) dan produksi massal (3-5 minggu). Kami juga dapat membantu dengan component sourcing jika diperlukan.
                  </p>
                ) : product.id === 'plastic-injection' ? (
                  <p>
                    Produk injection molding dibuat sesuai order dengan lead time 1-2 minggu untuk prototype dan 3-5 minggu untuk produksi massal. Kami dapat menyediakan sample untuk testing terlebih dahulu.
                  </p>
                ) : (
                  <p>
                    Ketersediaan {product.name} bervariasi tergantung model dan spesifikasi. Silakan hubungi tim kami untuk informasi stok terkini dan lead time pengiriman.
                  </p>
                )}
              </div>
            </details>
            ...
            <details className="group bg-white rounded-xl border border-neutral-200 overflow-hidden transition-all duration-200 hover:border-primary/40 hover:shadow-md">
              ...
              <div className="px-3 md:px-4 pb-3 md:pb-4 text-sm text-neutral-600 leading-relaxed">
                <p className="mb-2">Ya, kami menyediakan:</p>
                <ul className="space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="text-primary mt-0.5">•</span>
                    <span>Datasheet dan dokumentasi teknis</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-primary mt-0.5">•</span>
                    <span>Konsultasi teknis dan aplikasi</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-primary mt-0.5">•</span>
                    <span>Training dan support implementasi</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-primary mt-0.5">•</span>
                    <span>Dukungan purna jual</span>
                  </li>
                </ul>
              </div>
            </details>
