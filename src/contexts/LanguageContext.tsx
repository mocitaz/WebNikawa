...
function getDefaultTranslations(): typeof import('../locales/id').translations {
  ...
  return {
    ...
    contactPage: { hero: { eyebrow: 'Hubungi Kami', title: 'Kami siap membantu Anda', description: 'Hubungi tim kami untuk konsultasi, penawaran, atau informasi lebih lanjut tentang produk dan layanan NTI.' }, contactInfo: { eyebrow: 'Informasi Kontak', title: 'Hubungi kami melalui berbagai saluran', address: { label: 'Alamat' }, email: { label: 'Email' }, phone: { label: 'Telepon & WhatsApp', whatsapp: 'WhatsApp' }, hours: { label: 'Jam Operasional', value: 'Senin - Sabtu: 10.00 - 20.00' }, buttons: { whatsapp: 'Hubungi via WhatsApp', email: 'Email Kami' } }, form: { eyebrow: 'Kirim Pesan', title: 'Isi formulir di bawah ini', fields: { name: { label: 'Nama *', placeholder: 'Nama lengkap Anda' }, company: { label: 'Perusahaan', placeholder: 'Nama perusahaan Anda' }, email: { label: 'Email *', placeholder: 'email@example.com' }, phone: { label: 'Telepon', placeholder: '+62 xxx xxxx xxxx' }, message: { label: 'Kebutuhan / Pesan *', placeholder: 'Tulis kebutuhan atau pesan Anda di sini...' } }, submit: 'Kirim Pesan', success: 'Terima kasih! Pesan Anda telah diterima. Tim kami akan menghubungi Anda segera.' }, map: { eyebrow: 'Lokasi Kantor', title: 'Kunjungi kantor kami di Jababeka' }, cta: { eyebrow: 'Siap Bekerja Sama dengan NTI?', title: 'Hubungi kami hari ini untuk konsultasi dan solusi terbaik', description: 'Tim kami siap membantu Anda menemukan solusi terbaik untuk kebutuhan industri Anda', contactButton: 'Hubungi Kami', whatsappButton: 'Chat WhatsApp' }, faq: { eyebrow: 'Pertanyaan yang Sering Diajukan', title: 'Informasi penting tentang NTI', items: [{ question: 'Nikawa itu perusahaan apa?', answer: 'PT Nikawa Teknika Indonesia adalah distributor resmi komponen elektronik dan produk plastik industri yang berdiri sejak 13 Agustus 2014, berlokasi di Kawasan Industri Jababeka II, Cikarang, Bekasi.' }, { question: 'Apa saja produk utama Nikawa?', answer: 'Kami menyediakan 8 lini produk: Komponen Elektronik, Perakitan PCBA, GSM/4G Modem, LED Road Studs, Resin Plastik, Produk Injeksi Plastik Custom, Smart Meter, dan Fiber Optic Gas Meter.' }, { question: 'Apakah Nikawa melayani perakitan PCBA?', answer: 'Ya. Kami memiliki partner EMS di Jababeka dengan 4 line SMT high-speed, standar IPC-A-610 Class 2 (bisa Class 3 untuk proyek medis/automotive safety).' }, { question: 'Apakah barang ready stock?', answer: 'Hampir semua komponen elektronik dan resin plastik ready stock di gudang Jababeka. PCBA prototype 3–7 hari, produksi massal 3–5 minggu.' }, { question: 'Bagaimana cara menghubungi atau minta penawaran?', answer: 'Email: cs@nikawa-indonesia.com | Telepon/WhatsApp: +62 21 2945 3728. Kami balas maksimal 1×24 jam (hari kerja).' }] } },
    downloadsPage: { hero: { eyebrow: 'Download Center', title: 'Unduh Company Profile PT Nikawa Teknika Indonesia', description: 'Akses dokumen resmi perusahaan dalam format PDF untuk informasi lengkap tentang produk dan layanan NTI.' }, stats: { experience: 'Tahun Pengalaman', productLines: 'Lini Produk', established: 'Didirikan' }, download: { title: 'Company Profile', description: 'Profil lengkap perusahaan PT Nikawa Teknika Indonesia', button: 'Download Company Profile', info: 'File PDF akan diunduh langsung ke perangkat Anda. Pastikan koneksi internet stabil.' }, contents: { title: 'Isi Company Profile', items: [{ icon: 'company-profile', text: 'Profil Perusahaan & Sejarah' }, { icon: 'portfolio', text: 'Portofolio Produk & Layanan' }, { icon: 'team', text: 'Tim & Organisasi' }, { icon: 'achievements', text: 'Pencapaian & Sertifikasi' }, { icon: 'contact', text: 'Kontak & Lokasi' }] }, whyDownload: { title: 'Mengapa Download Company Profile?', items: [{ icon: 'info', text: 'Informasi lengkap tentang perusahaan dan layanan kami' }, { icon: 'reference', text: 'Referensi untuk presentasi dan proposal bisnis' }, { icon: 'portfolio', text: 'Detail portofolio produk dan kapabilitas' }, { icon: 'contact', text: 'Kontak dan informasi untuk kolaborasi' }] }, cta: { eyebrow: 'Tertarik Bekerja Sama?', title: 'Hubungi kami hari ini untuk konsultasi dan solusi terbaik', description: 'Tim kami siap membantu Anda menemukan solusi terbaik untuk kebutuhan industri Anda', contactButton: 'Hubungi Kami', whatsappButton: 'Chat WhatsApp' } },
    footer: { tagline: 'Distribusi & Solusi Manufaktur Elektronik, Plastik, dan Komponen Industri sejak 2014', distributorOf: 'Distributor of:', navigation: 'Navigasi', contact: 'Kontak', whatsapp: 'WhatsApp', information: 'Informasi', established: 'Didirikan', legal: 'Legal', privacyPolicy: 'Privacy Policy', contactUs: 'Hubungi Kami', allRightsReserved: 'All rights reserved.', philosophy: 'Membangun dengan Presisi, Berkarya dengan Inovasi' },
  }
}
